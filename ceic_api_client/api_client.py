...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.__init_rest_client()
        self.default_headers = {}
        if header_name is not None:
            self.default_headers[header_name] = header_value
        self.cookie = cookie
        # Set default User-Agent.
        self.user_agent = 'Swagger-Codegen/2.11.4.389/python'
    ...
    def set_proxy(self, url=None, username=None, password=None):
        self.configuration.set_proxy(proxy_url=url, proxy_username=username, proxy_password=password)
        self.__init_rest_client()
