...
class UserdefinedSeriesDataResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedSeriesDataResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedSeriesDataResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedSeriesDataResult.  # noqa: E501


        :return: The data of this UserdefinedSeriesDataResult.  # noqa: E501
        :rtype: UserdefinedSeriesDataResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedSeriesDataResult.


        :param data: The data of this UserdefinedSeriesDataResult.  # noqa: E501
        :type: UserdefinedSeriesDataResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedSeriesDataResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedSeriesDataResult):
            return False
