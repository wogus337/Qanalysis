...
class InsightSeriesPaginatedResultData(object):
    ...
    def __init__(self, total=None, items=None, _configuration=None):  # noqa: E501
        """InsightSeriesPaginatedResultData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def total(self):
        """Gets the total of this InsightSeriesPaginatedResultData.  # noqa: E501

        Total number of the series in an insight  # noqa: E501

        :return: The total of this InsightSeriesPaginatedResultData.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this InsightSeriesPaginatedResultData.

        Total number of the series in an insight  # noqa: E501

        :param total: The total of this InsightSeriesPaginatedResultData.  # noqa: E501
        :type: int
        """
    ...
    @property
    def items(self):
        """Gets the items of this InsightSeriesPaginatedResultData.  # noqa: E501

        An array of insight series  # noqa: E501

        :return: The items of this InsightSeriesPaginatedResultData.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this InsightSeriesPaginatedResultData.

        An array of insight series  # noqa: E501

        :param items: The items of this InsightSeriesPaginatedResultData.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InsightSeriesPaginatedResultData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InsightSeriesPaginatedResultData):
            return False
