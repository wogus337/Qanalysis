...
class UserdefinedDeletedSeriesDataBulkResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[UserdefinedTimePoint]'
    }
    ...
    def __init__(self, items=None, _configuration=None):  # noqa: E501
        """UserdefinedDeletedSeriesDataBulkResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedDeletedSeriesDataBulkResponse.  # noqa: E501

        List of the deleted series timepoints  # noqa: E501

        :return: The items of this UserdefinedDeletedSeriesDataBulkResponse.  # noqa: E501
        :rtype: list[UserdefinedTimePoint]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this UserdefinedDeletedSeriesDataBulkResponse.

        List of the deleted series timepoints  # noqa: E501

        :param items: The items of this UserdefinedDeletedSeriesDataBulkResponse.  # noqa: E501
        :type: list[UserdefinedTimePoint]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedDeletedSeriesDataBulkResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedDeletedSeriesDataBulkResponse):
            return False
