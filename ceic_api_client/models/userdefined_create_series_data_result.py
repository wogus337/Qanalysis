...
class UserdefinedCreateSeriesDataResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedCreatedSeriesDataResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedCreateSeriesDataResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedCreateSeriesDataResult.  # noqa: E501


        :return: The data of this UserdefinedCreateSeriesDataResult.  # noqa: E501
        :rtype: UserdefinedCreatedSeriesDataResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedCreateSeriesDataResult.


        :param data: The data of this UserdefinedCreateSeriesDataResult.  # noqa: E501
        :type: UserdefinedCreatedSeriesDataResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedCreateSeriesDataResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedCreateSeriesDataResult):
            return False
