...
class VintageDatesResult(object):
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """VintageDatesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this VintageDatesResult.  # noqa: E501

        An array of vintage dates  # noqa: E501

        :return: The data of this VintageDatesResult.  # noqa: E501
        :rtype: list[VintageDate]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this VintageDatesResult.

        An array of vintage dates  # noqa: E501

        :param data: The data of this VintageDatesResult.  # noqa: E501
        :type: list[VintageDate]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VintageDatesResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VintageDatesResult):
            return False
