...
class UserdefinedDeletedSeries(object):
    ...
    def __init__(self, id=None, _configuration=None):  # noqa: E501
        """UserdefinedDeletedSeries - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this UserdefinedDeletedSeries.  # noqa: E501

        Deleted series ID - an integer prefixed with `UD`  # noqa: E501

        :return: The id of this UserdefinedDeletedSeries.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserdefinedDeletedSeries.

        Deleted series ID - an integer prefixed with `UD`  # noqa: E501

        :param id: The id of this UserdefinedDeletedSeries.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedDeletedSeries, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedDeletedSeries):
            return False
