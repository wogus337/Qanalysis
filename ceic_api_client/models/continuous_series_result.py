...
class ContinuousSeriesResult(object):
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """ContinuousSeriesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ContinuousSeriesResult.  # noqa: E501


        :return: The data of this ContinuousSeriesResult.  # noqa: E501
        :rtype: ContinuousSeriesList
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ContinuousSeriesResult.


        :param data: The data of this ContinuousSeriesResult.  # noqa: E501
        :type: ContinuousSeriesList
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContinuousSeriesResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContinuousSeriesResult):
            return False
