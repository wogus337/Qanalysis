...
class UserdefinedClonedSeriesResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[UserdefinedClonedSeries]'
    }
    ...
    def __init__(self, items=None, _configuration=None):  # noqa: E501
        """UserdefinedClonedSeriesResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedClonedSeriesResponse.  # noqa: E501

        List of the created series  # noqa: E501

        :return: The items of this UserdefinedClonedSeriesResponse.  # noqa: E501
        :rtype: list[UserdefinedClonedSeries]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this UserdefinedClonedSeriesResponse.

        List of the created series  # noqa: E501

        :param items: The items of this UserdefinedClonedSeriesResponse.  # noqa: E501
        :type: list[UserdefinedClonedSeries]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedClonedSeriesResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedClonedSeriesResponse):
            return False
