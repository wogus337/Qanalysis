...
class UserdefinedPatchedSeriesDataResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[UserdefinedPatchedTimePoint]'
    }
    ...
    def __init__(self, items=None, _configuration=None):  # noqa: E501
        """UserdefinedPatchedSeriesDataResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedPatchedSeriesDataResponse.  # noqa: E501

        Patched series timepoint new value  # noqa: E501

        :return: The items of this UserdefinedPatchedSeriesDataResponse.  # noqa: E501
        :rtype: list[UserdefinedPatchedTimePoint]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this UserdefinedPatchedSeriesDataResponse.

        Patched series timepoint new value  # noqa: E501

        :param items: The items of this UserdefinedPatchedSeriesDataResponse.  # noqa: E501
        :type: list[UserdefinedPatchedTimePoint]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedPatchedSeriesDataResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedPatchedSeriesDataResponse):
            return False
