...
class UserdefinedCreatedSeriesResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[UserdefinedCreatedSeries]'
    }
    ...
    def __init__(self, items=None, _configuration=None):  # noqa: E501
        """UserdefinedCreatedSeriesResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedCreatedSeriesResponse.  # noqa: E501

        List of the found series  # noqa: E501

        :return: The items of this UserdefinedCreatedSeriesResponse.  # noqa: E501
        :rtype: list[UserdefinedCreatedSeries]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this UserdefinedCreatedSeriesResponse.

        List of the found series  # noqa: E501

        :param items: The items of this UserdefinedCreatedSeriesResponse.  # noqa: E501
        :type: list[UserdefinedCreatedSeries]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedCreatedSeriesResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedCreatedSeriesResponse):
            return False
