...
class UserdefinedSeriesDataResponse(object):
    ...
    def __init__(self, items=None, _configuration=None):  # noqa: E501
        """UserdefinedSeriesDataResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedSeriesDataResponse.  # noqa: E501

        List of the found series timepoints  # noqa: E501

        :return: The items of this UserdefinedSeriesDataResponse.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this UserdefinedSeriesDataResponse.

        List of the found series timepoints  # noqa: E501

        :param items: The items of this UserdefinedSeriesDataResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedSeriesDataResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedSeriesDataResponse):
            return False
