...
class InsightSeriesPaginatedResult(object):
    ...
    """
    swagger_types = {
        'data': 'InsightSeriesPaginatedResultData'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """InsightSeriesPaginatedResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this InsightSeriesPaginatedResult.  # noqa: E501


        :return: The data of this InsightSeriesPaginatedResult.  # noqa: E501
        :rtype: InsightSeriesPaginatedResultData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this InsightSeriesPaginatedResult.


        :param data: The data of this InsightSeriesPaginatedResult.  # noqa: E501
        :type: InsightSeriesPaginatedResultData
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InsightSeriesPaginatedResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InsightSeriesPaginatedResult):
            return False
