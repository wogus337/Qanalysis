...
class UserdefinedDeleteSeriesDataResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedDeletedSeriesDataResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedDeleteSeriesDataResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedDeleteSeriesDataResult.  # noqa: E501


        :return: The data of this UserdefinedDeleteSeriesDataResult.  # noqa: E501
        :rtype: UserdefinedDeletedSeriesDataResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedDeleteSeriesDataResult.


        :param data: The data of this UserdefinedDeleteSeriesDataResult.  # noqa: E501
        :type: UserdefinedDeletedSeriesDataResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedDeleteSeriesDataResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedDeleteSeriesDataResult):
            return False
