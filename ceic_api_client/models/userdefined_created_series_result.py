...
class UserdefinedCreatedSeriesResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedCreatedSeriesResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedCreatedSeriesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedCreatedSeriesResult.  # noqa: E501


        :return: The data of this UserdefinedCreatedSeriesResult.  # noqa: E501
        :rtype: UserdefinedCreatedSeriesResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedCreatedSeriesResult.


        :param data: The data of this UserdefinedCreatedSeriesResult.  # noqa: E501
        :type: UserdefinedCreatedSeriesResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedCreatedSeriesResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedCreatedSeriesResult):
            return False
