...
class ContinuousSeriesWithAppliedFunctionsResult(object):
    ...
    """
    swagger_types = {
        'data': 'ContinuousSeriesWithAppliedFunctionsList'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """ContinuousSeriesWithAppliedFunctionsResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ContinuousSeriesWithAppliedFunctionsResult.  # noqa: E501


        :return: The data of this ContinuousSeriesWithAppliedFunctionsResult.  # noqa: E501
        :rtype: ContinuousSeriesWithAppliedFunctionsList
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ContinuousSeriesWithAppliedFunctionsResult.


        :param data: The data of this ContinuousSeriesWithAppliedFunctionsResult.  # noqa: E501
        :type: ContinuousSeriesWithAppliedFunctionsList
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ContinuousSeriesWithAppliedFunctionsResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContinuousSeriesWithAppliedFunctionsResult):
            return False
