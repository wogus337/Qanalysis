...
class UserdefinedClonedSeries(object):
    ...
    def __init__(self, entity_id=None, id=None, series_code=None, reference_series_id=None, _configuration=None):  # noqa: E501
        """UserdefinedClonedSeries - a model defined in Swagger"""  # noqa: E501
        ...
        self._reference_series_id = None
        ...
        if reference_series_id is not None:
            self.reference_series_id = reference_series_id

    @property
    def entity_id(self):
        """Gets the entity_id of this UserdefinedClonedSeries.  # noqa: E501

        Requested Entity ID  # noqa: E501

        :return: The entity_id of this UserdefinedClonedSeries.  # noqa: E501
        :rtype: str
        """
    ...
    def entity_id(self, entity_id):
        """Sets the entity_id of this UserdefinedClonedSeries.

        Requested Entity ID  # noqa: E501

        :param entity_id: The entity_id of this UserdefinedClonedSeries.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this UserdefinedClonedSeries.  # noqa: E501

        Created userdefined series ID - an integer prefixed with `UD`  # noqa: E501

        :return: The id of this UserdefinedClonedSeries.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UserdefinedClonedSeries.

        Created userdefined series ID - an integer prefixed with `UD`  # noqa: E501

        :param id: The id of this UserdefinedClonedSeries.  # noqa: E501
        :type: str
        """
    ...
    def series_code(self):
        """Gets the series_code of this UserdefinedClonedSeries.  # noqa: E501

        Created userdefined series SR code - an integer prefixed with `SRUD`  # noqa: E501

        :return: The series_code of this UserdefinedClonedSeries.  # noqa: E501
        :rtype: str
        """
    ...
    def series_code(self, series_code):
        """Sets the series_code of this UserdefinedClonedSeries.

        Created userdefined series SR code - an integer prefixed with `SRUD`  # noqa: E501

        :param series_code: The series_code of this UserdefinedClonedSeries.  # noqa: E501
        :type: str
        """
    ...
    @property
    def reference_series_id(self):
        """Gets the reference_series_id of this UserdefinedClonedSeries.  # noqa: E501

        Id of the cloned CEIC series  # noqa: E501

        :return: The reference_series_id of this UserdefinedClonedSeries.  # noqa: E501
        :rtype: int
        """
        return self._reference_series_id

    @reference_series_id.setter
    def reference_series_id(self, reference_series_id):
        """Sets the reference_series_id of this UserdefinedClonedSeries.

        Id of the cloned CEIC series  # noqa: E501

        :param reference_series_id: The reference_series_id of this UserdefinedClonedSeries.  # noqa: E501
        :type: int
        """

        self._reference_series_id = reference_series_id
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedClonedSeries, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedClonedSeries):
            return False
