...
class UserdefinedDeletedSeriesResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[UserdefinedDeletedSeries]'
    }
    ...
    def __init__(self, items=None, _configuration=None):  # noqa: E501
        """UserdefinedDeletedSeriesResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedDeletedSeriesResponse.  # noqa: E501

        List of the deleted series  # noqa: E501

        :return: The items of this UserdefinedDeletedSeriesResponse.  # noqa: E501
        :rtype: list[UserdefinedDeletedSeries]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this UserdefinedDeletedSeriesResponse.

        List of the deleted series  # noqa: E501

        :param items: The items of this UserdefinedDeletedSeriesResponse.  # noqa: E501
        :type: list[UserdefinedDeletedSeries]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedDeletedSeriesResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedDeletedSeriesResponse):
            return False
