...
class ReleaseScheduleType(object):
    ...
    def __init__(self, id=None, name=None, _configuration=None):  # noqa: E501
        """ReleaseScheduleType - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this ReleaseScheduleType.  # noqa: E501

        The ID of the type of the release schedule.  F - Final P - Preliminary R - Revision  # noqa: E501

        :return: The id of this ReleaseScheduleType.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ReleaseScheduleType.

        The ID of the type of the release schedule.  F - Final P - Preliminary R - Revision  # noqa: E501

        :param id: The id of this ReleaseScheduleType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ReleaseScheduleType.  # noqa: E501

        The type name  # noqa: E501

        :return: The name of this ReleaseScheduleType.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ReleaseScheduleType.

        The type name  # noqa: E501

        :param name: The name of this ReleaseScheduleType.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReleaseScheduleType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReleaseScheduleType):
            return False
