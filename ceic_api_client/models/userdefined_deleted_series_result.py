...
class UserdefinedDeletedSeriesResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedDeletedSeriesResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedDeletedSeriesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedDeletedSeriesResult.  # noqa: E501


        :return: The data of this UserdefinedDeletedSeriesResult.  # noqa: E501
        :rtype: UserdefinedDeletedSeriesResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedDeletedSeriesResult.


        :param data: The data of this UserdefinedDeletedSeriesResult.  # noqa: E501
        :type: UserdefinedDeletedSeriesResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedDeletedSeriesResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedDeletedSeriesResult):
            return False
