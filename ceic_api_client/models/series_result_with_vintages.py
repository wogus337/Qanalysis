...
class SeriesResultWithVintages(object):
    ...
    def __init__(self, data=None, errors=None, _configuration=None):  # noqa: E501
        """SeriesResultWithVintages - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this SeriesResultWithVintages.  # noqa: E501

        An array of series  # noqa: E501

        :return: The data of this SeriesResultWithVintages.  # noqa: E501
        :rtype: list[SeriesWithVintages]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this SeriesResultWithVintages.

        An array of series  # noqa: E501

        :param data: The data of this SeriesResultWithVintages.  # noqa: E501
        :type: list[SeriesWithVintages]
        """
    ...
    @property
    def errors(self):
        """Gets the errors of this SeriesResultWithVintages.  # noqa: E501
        ...
        :return: The errors of this SeriesResultWithVintages.  # noqa: E501
    ...
    def errors(self, errors):
        """Sets the errors of this SeriesResultWithVintages.

        List of series-related errors. In some cases both errors and data could be returned, i.e. when some of the requested series are missing/unsubscribed but others available.  # noqa: E501

        :param errors: The errors of this SeriesResultWithVintages.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SeriesResultWithVintages, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeriesResultWithVintages):
            return False
