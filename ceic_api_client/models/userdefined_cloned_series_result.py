...
class UserdefinedClonedSeriesResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedClonedSeriesResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedClonedSeriesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedClonedSeriesResult.  # noqa: E501


        :return: The data of this UserdefinedClonedSeriesResult.  # noqa: E501
        :rtype: UserdefinedClonedSeriesResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedClonedSeriesResult.


        :param data: The data of this UserdefinedClonedSeriesResult.  # noqa: E501
        :type: UserdefinedClonedSeriesResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedClonedSeriesResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedClonedSeriesResult):
            return False
