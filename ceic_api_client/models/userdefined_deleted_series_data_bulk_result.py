...
class UserdefinedDeletedSeriesDataBulkResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedDeletedSeriesDataBulkResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedDeletedSeriesDataBulkResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedDeletedSeriesDataBulkResult.  # noqa: E501


        :return: The data of this UserdefinedDeletedSeriesDataBulkResult.  # noqa: E501
        :rtype: UserdefinedDeletedSeriesDataBulkResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedDeletedSeriesDataBulkResult.


        :param data: The data of this UserdefinedDeletedSeriesDataBulkResult.  # noqa: E501
        :type: UserdefinedDeletedSeriesDataBulkResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedDeletedSeriesDataBulkResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedDeletedSeriesDataBulkResult):
            return False
