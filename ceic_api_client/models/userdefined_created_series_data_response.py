...
class UserdefinedCreatedSeriesDataResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[UserdefinedCreatedTimePoint]'
    }
    ...
    def __init__(self, items=None, _configuration=None):  # noqa: E501
        """UserdefinedCreatedSeriesDataResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedCreatedSeriesDataResponse.  # noqa: E501

        List of the created series timepoints  # noqa: E501

        :return: The items of this UserdefinedCreatedSeriesDataResponse.  # noqa: E501
        :rtype: list[UserdefinedCreatedTimePoint]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this UserdefinedCreatedSeriesDataResponse.

        List of the created series timepoints  # noqa: E501

        :param items: The items of this UserdefinedCreatedSeriesDataResponse.  # noqa: E501
        :type: list[UserdefinedCreatedTimePoint]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedCreatedSeriesDataResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedCreatedSeriesDataResponse):
            return False
