...
class UserdefinedSeriesResponse(object):
    ...
    def __init__(self, total=None, items=None, _configuration=None):  # noqa: E501
        """UserdefinedSeriesResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def total(self):
        """Gets the total of this UserdefinedSeriesResponse.  # noqa: E501

        The total number of the found series  # noqa: E501

        :return: The total of this UserdefinedSeriesResponse.  # noqa: E501
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        """Sets the total of this UserdefinedSeriesResponse.

        The total number of the found series  # noqa: E501

        :param total: The total of this UserdefinedSeriesResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedSeriesResponse.  # noqa: E501

        List of the found series  # noqa: E501

        :return: The items of this UserdefinedSeriesResponse.  # noqa: E501
        :rtype: list[UserdefinedSeries]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this UserdefinedSeriesResponse.

        List of the found series  # noqa: E501

        :param items: The items of this UserdefinedSeriesResponse.  # noqa: E501
        :type: list[UserdefinedSeries]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedSeriesResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedSeriesResponse):
            return False
