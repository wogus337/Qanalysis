...
class UserdefinedSeriesResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedSeriesResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedSeriesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedSeriesResult.  # noqa: E501


        :return: The data of this UserdefinedSeriesResult.  # noqa: E501
        :rtype: UserdefinedSeriesResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedSeriesResult.


        :param data: The data of this UserdefinedSeriesResult.  # noqa: E501
        :type: UserdefinedSeriesResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedSeriesResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedSeriesResult):
            return False
