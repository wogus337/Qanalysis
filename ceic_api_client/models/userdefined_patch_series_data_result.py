...
class UserdefinedPatchSeriesDataResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserdefinedPatchedSeriesDataResponse'
    }
    ...
    def __init__(self, data=None, _configuration=None):  # noqa: E501
        """UserdefinedPatchSeriesDataResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserdefinedPatchSeriesDataResult.  # noqa: E501


        :return: The data of this UserdefinedPatchSeriesDataResult.  # noqa: E501
        :rtype: UserdefinedPatchedSeriesDataResponse
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserdefinedPatchSeriesDataResult.


        :param data: The data of this UserdefinedPatchSeriesDataResult.  # noqa: E501
        :type: UserdefinedPatchedSeriesDataResponse
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedPatchSeriesDataResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedPatchSeriesDataResult):
            return False
