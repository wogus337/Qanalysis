...
class UserdefinedDeletedSeriesDataResponse(object):
    ...
    """
    swagger_types = {
        'items': 'list[UserdefinedDeletedTimePoint]'
    }
    ...
    def __init__(self, items=None, _configuration=None):  # noqa: E501
        """UserdefinedDeletedSeriesDataResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this UserdefinedDeletedSeriesDataResponse.  # noqa: E501

        List of the deleted series timepoints  # noqa: E501

        :return: The items of this UserdefinedDeletedSeriesDataResponse.  # noqa: E501
        :rtype: list[UserdefinedDeletedTimePoint]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this UserdefinedDeletedSeriesDataResponse.

        List of the deleted series timepoints  # noqa: E501

        :param items: The items of this UserdefinedDeletedSeriesDataResponse.  # noqa: E501
        :type: list[UserdefinedDeletedTimePoint]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserdefinedDeletedSeriesDataResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserdefinedDeletedSeriesDataResponse):
            return False
